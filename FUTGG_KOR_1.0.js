...
(function() {
    ...
    const translations = {
        ...
        "december": "12월",
        "CHEM LINKS": "조직력 링크",
        "Top Chemistry Links": "조직력 링크되는 선수 목록",
        "EA FC 25": "EA FC 25",
        "Players": "선수",
        "Evolutions": "진화",
        "SBC": "SBC",
                    ...
                    if (child.nodeType === Node.TEXT_NODE) {
                        ...
                        for (const key in translations) {
                            if (key.toLowerCase() === lowerText) {
                                child.nodeValue = translations[key];
                                break;
                            }
                        }
                    }
    ...
    // 동적 변경 감지 후 번역 적용 (MutationObserver 활용)
